...
const articleContent: Record<string, ArticleContent> = {
    'what-changed-in-lensy-after-rechecking-ai-ready-docs-signals': {
        ...
        sections: [
            ...
            {
                heading: 'Markdown Is Broader Than .md',
                paragraphs: [
            ...
            {
                heading: 'llms.txt Discovery Is Broader Than One Path',
                paragraphs: [
        ...
        references: [
            { label: 'Mintlify. "llms.txt." Documentation, 2025.', url: 'https://www.mintlify.com/docs/ai/llmstxt' },
            { label: 'Cloudflare. "Introducing Markdown for Agents." Cloudflare Blog, 2026.', url: 'https://blog.cloudflare.com/markdown-for-agents/' },
            { label: 'Howard, Jeremy. "The /llms.txt file." llmstxt.org, 2024.', url: 'https://llmstxt.org' },
            { label: 'Chen et al. "WebSRC: A Dataset for Web-Based Structural Reading Comprehension." EMNLP, 2021.', url: 'https://aclanthology.org/2021.emnlp-main.343/' },
        ],
    },
